...
describe Kiki::Matchers::From do
  ...
  describe '#match' do
    context 'when Message.from is a Array' do
      let(:arguments) do
        {
          pattern: /github.com/
        }
      ...
      let(:message) do
        instance_double('Message', from: ['rike422@github.com', 'rike422+2@github.com'])
      end
    ...
    context 'when Message.from be a string' do
      let(:arguments) do
        {
          pattern: /github.com/
        }
      ...
      let(:message) do
        instance_double('Message', from: 'rike422@github.com')
      end
      it 'should return Array of MatchData' do
        expect(described_incetane.match(message)).to_not be_a(Array)
      end
